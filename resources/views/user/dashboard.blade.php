...
<head>
    ...
    <style type="text/css">
        ...
        .pcoded-main-container {
            background-image: url("{{asset('files/assets/images/hotel_index2.jpg')}}");
        }
      </style>
</head>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card bg-c-green text-white">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <p class="m-b-5">Reservations</p>
                                                                <h4 class="m-b-0">{{ App\Models\Hotel\Reservation::count() }}</h4>
                                                            </div>
                                                            <div class="col col-auto text-right">
                                                                <i
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                ...
                                                                <h4 class="m-b-0">{{ App\Models\Hotel\Client::count() }}</h4>
                                                            </div>
                                                            <div class="col col-auto text-right">
                                                                <i
                                                                    class="feather icon-users f-50 text-c-blue"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
