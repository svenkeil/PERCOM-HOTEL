...
<head>
    ...
    <title>PERCOM-HOTEL|USER LIST</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Utilisateurs</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                            ...
                                                            <tbody>
                                                                @foreach($users as $user)
                                                                    <tr>
                                                                        <td>{{ $user['pseudo']}}</td>
                                                                        <td>{{ $user['email']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $user['role']}}</td>
