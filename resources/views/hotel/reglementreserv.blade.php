...
<head>
    ...
    <title>PERCOM-HOTEL|RESERVATION PAY</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Paiement RESERVATION</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="reglement" onsubmit="return AddReglement()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Reglement Reservation Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" readonly="true" value=""  id="chambre_actuelle" name="chambre_actuelle"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" readonly="true"   id="prix_chambre" value="" name="prix_chambre"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" readonly="true" value=""  id="mode_paiement" name="mode_paiement"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
