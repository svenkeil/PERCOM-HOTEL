...
<head>
    ...
    <title>PERCOM-HOTEL|DELODGEMENT HISTORY</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste des delogements </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="7">DELOGEMENT INFORMATION</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($delogements as $delogement)
                                                                    @if($delogement['cloturer'] == 'Non')
                                                                    <tr>
                                                                        <td>{{ $valeurchambre::find($delogement['nv_chambre'])['name'] }}</td>
                                                                        <td>{{ $delogement['ancienne_chambre']}}</td>
                                                                        <td>{{ $delogement['reception_id']}}</td>
                                                                        <td>{{ $delogement['id_delog']}}</td>
                                                                        <td>{{ $delogement['raison']}}</td>
                                                                        <td>{{ $valeurhotel::find($delogement['hotel_id'])['name'] }}</td>
                                                                        <td>{{ $delogement['created_at']}}</td>
