...
<head>
    ...
    <title>PERCOM-HOTEL|CUSTOMER TYPES</title>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES TYPES DE CLIENTS</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Type Clients</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="3">TYPE DE CLIENT INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>NOM DU TYPE DE CLIENT</th>
                                                                    <th>DESCRIPTION</th>
                                    ...
                                    <!-- Formulaire previsualisation qualite chambre -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom du type de client</label>
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="type" name="nom_type"/>
                                                        </div>
                                                        <div class="form-group">
                                    ...
                                    <!-- Formulaire ajout qualite chambre -->
                                    <form class="ajoutch" onsubmit="return AddCustomerType()">
                                        <div class="md-content">
                                            <h3 id="modal_header" style="background-color: #b82710"></h3>
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom du type de client</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="nom_type" name="nom_type"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="description" name="description"/>
                                                        </div>
                                                    </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                ...
                                                <div class="row">
                                                <div class="col-12 col-sm-6">
                                                        <button type="submit" class="btn btn-primary waves-effect valid" value="submit">Valider<i class="fa fa-check-square-o" style="color:green;"></i> <i class="fas fa-spinner fa-spin" style="display:none" class="spinner" id="spinner-login"></i></button>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
...
<script>
  ...
  function AddCustomerType() {
    ...
    addingCustomerType(info);     
  }

  // login pour la connexion
  function addingCustomerType(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-customer-type')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('customer-type')}}";
                }, 1000);
            }
...
<script>
    function previsualiser(id,name)
    {
...
<script>
    function ajoutchambre() {
        ...
        document.getElementById("modal_header").innerHTML='Ajout d\'un type ce client';
    }
