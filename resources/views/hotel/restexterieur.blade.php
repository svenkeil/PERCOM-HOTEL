                                                ...
                                                <div class="card-block">
                                                    <form class="restauration" onsubmit="return AddRestauration()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Restauration Client: <strong style="color:#5e281c"></strong></h3>
                                                                <div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" value=""  id="nom_client" name="nom_client"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Numero de piece</label>
                                                                                    <input type="text" class="form-control form-control-primary" value=""  id="num_piece" name="num_piece"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                    </div>
...
<script>
  ...
  function AddRestauration() {
    ...
    var errors = [];
      ...
      info["remarque"] = $('#remarque').val(); 
        ...
        info["mode_paiement_id"] = $(".modepaiement").val();
      }
      // console.log(info);
      console.log(errors);
    if (errors.length > 0) {
  ...
  function addingRestauration(info) {
    $.ajax({
        ...
        url: '{{route('process-restauration-exterieur')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('liste-restauration')}}";
                }, 1000);
            }
