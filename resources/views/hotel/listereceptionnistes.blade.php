...
<head>
    ...
    <title>PERCOM-HOTEL|RECEPTIONNISTS LIST</title>
    ...
    <style type="text/css">
        ...
        .pcoded-main-container {
            background-image: url("{{asset('files/assets/images/receptionnistes.jpg')}}"); 
            }
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES RECEPTIONNISTES</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Receptionnistes</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <div class="table-responsive dt-responsive">
                                                        <table id="complex-header"
                                                            ...
                                                            <tbody>
                                                                @foreach($receptionnistes as $recep)
                                                                    <tr>
                                                                        <td>{{$valeuruser::find($recep['user_id'])['pseudo']}}</td>
                                                                        <td>{{$valeuruser::find($recep['user_id'])['email']}}</td>
                                                                        <td>{{ $recep['matricule']}}</td>
                                                                        <td>{{ $recep['start_date']}}</td>
                                                                        <td>{{ $recep['end_date']}}</td>
                                                                        <td>{{ $recep['no_compte']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $recep['revenu']}}</td>
