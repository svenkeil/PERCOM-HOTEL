...
<head>
    ...
    <title>PERCOM-HOTEL|PARTENAIRES</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">PARTENAIRES</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <tbody>
                                                                @foreach($partenaires as $parte)
                                                                    <tr>
                                                                        <td>{{ $parte['matricule']}}</td>
                                                                        <td>{{ $parte['name']}}</td>
                                                                        <td>{{ $parte['phone']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ number_format($parte['solde'], 1)}}</td>
                                                                        <td style="color: #318297;font-weight: bold">{{ $parte['date_debut']}}</td>
                                                                        <td style="color: #318297;font-weight: bold">{{ $parte['date_fin']}}</td>
                                                                        <td>{{ $parte['type_partenaire']}}</td>
                                                                        <td>{{ $parte['created_at']}}</td>
                                                                        <td>
