...
<head>
    ...
    <title>PERCOM-HOTEL|FORMULE CHAMBRE</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Formule Client</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-block">
                                                    <form class="restauration" onsubmit="return AddRestauration()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Formule Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-6">
                                                                            <div class="form-group">
                                                                                <label>Menu</label>
                                                                                <select name="menus" class="menus js-example-responsive col-sm-12"  multiple="multiple">
                                                                                        
                                                                                        <optgroup label="Petit Dejeuner">
                                                                                        @foreach($restaurations as $restauration)
                                                                                            @if($restauration['statut'] == 'Disponible')
                                                                                                    @if($restauration['type'] == 'Petit Dejeuner')
                                                                                                        
                                                                                                            <option value="{{ $restauration['id'] }}">{{ $restauration['name'] }}</option>
                                                                                                        
                                                                                                    @endif
                                                                                                    @endif
                                                                                        @endforeach
                                                                                        </optgroup>
                                                                                        <optgroup label="Dejeuner">
                                                                                        @foreach($restaurations as $restauration)
                                                                                            @if($restauration['statut'] == 'Disponible')
                                                                                                    @if($restauration['type'] == 'Dejeuner')
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Prix</label>
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" style="height:3.2rem;" value="0"  id="prix" name="prix"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <hr/>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{ $id->id }}"  id="id_reception" name="id_reception"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Chambre du client</label>
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{$valeurchambre::find($id->chambre_id)->name}}"  id="chambre_actuelle" name="chambre_actuelle"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                    </div>
                                                                    <hr/>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Heure</label>
                                                                                    <input type="time" class="form-control form-control-primary" id="heure" name="heure"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Date</label>
                                                                                    <input type="date" class="form-control form-control-primary" id="date" name="date"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                    </div>
...
<script type="text/javascript" src="{{ URL::asset('files/assets/supplement/menus.js')}}"></script>
  ...
  function AddRestauration() {
    ...
    var errors = [];
      ...
      info["remarque"] = $('#remarque').val(); 
        ...
        if($(".menus").val() == null) {
            errors.push($(".menus").val());
        } else {
        info["menus"] = $(".menus").val();
        }
      // console.log(info);
      console.log(errors);
    if (errors.length > 0) {
   ...
   addingRestauration(info);     
  }

  // login pour la connexion
  function addingRestauration(info) {
    $.ajax({
        ...
        url: '{{route('process-formule')}}', //process-user-register est  le fichier php excute cote serveur
...
<script>
    $(document).ready(function() {
        $('.menus').change(function() {
            ...
            if($('.menus').val().length == 0) {
                $('#prix').val(0);   
            }else {
                //alert($('.menus').val());
                for(i=0; i<$('.menus').val().length; i++) {
                    for(j=0; j< menus.length; j++) {
                        if(menus[j].id == $('.menus').val()[i]) {
                            let prixapi = parseFloat(menus[j].prix);
                            let prix = parseFloat(document.getElementById("prix").value);
                            document.getElementById("prix").value = prixapi + prix;
                           // alert( prixapi + prix );
                        }
                    }
                }
