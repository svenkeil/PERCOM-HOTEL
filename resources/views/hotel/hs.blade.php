...
<head>
    ...
    <title>PERCOM-HOTEL|HS BEDROOM</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">HS Bedroom</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="restauration" onsubmit="return AddRestauration()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Mettre Hors Service: <strong style="color:#5e281c">{{$id->name}}</strong></h3>
                                                                <div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{$id->name}}" font-weight: bolder" id="nom_chambre" name="nom_chambre"/>
                                                                                    <input type="hidden" class="form-control form-control-primary"  value="{{$id->id}}" font-weight: bolder" id="id_chambre" name="id_chambre"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Utilisateur</label>
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{Auth::user()->name}}" font-weight: bolder" id="chambre_actuelle" name="chambre_actuelle"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12">
                                                                            <textarea class="form-control form-control-primary" id="raison" name="raison" rows="3" placeholder="Raison"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <hr/>
                                                                    <div class="row">
...
<script>
  ...
  function addingRestauration(info) {
    $.ajax({
        ...
        url: '{{route('process-hs')}}', //process-user-register est  le fichier php excute cote serveur
