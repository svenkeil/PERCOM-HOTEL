...
<head>
    ...
    <title>PERCOM-HOTEL|HEBERGEMENTS LIST</title>
    ...
    <style type="text/css">
        ...
        .pcoded-main-container {
            background-image: url("{{asset('files/assets/images/respohebergement.png')}}");
            }
      </style>
</head>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES RESPONSABLES D'HEBERGEMENT</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Responsables Hebergement</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="8">COMPTE INFORMATIONS</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($respohebergements as $respo)
                                                                    <tr>
                                                                        <td>{{$valeuruser::find($respo['user_id'])['pseudo']}}</td>
                                                                        <td>{{$valeuruser::find($respo['user_id'])['email']}}</td>
                                                                        <td>{{ $respo['matricule']}}</td>
                                                                        <td>{{ $respo['start_date']}}</td>
                                                                        <td>{{ $respo['end_date']}}</td>
                                                                        <td>{{ $respo['no_compte']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $respo['revenu']}}</td>
