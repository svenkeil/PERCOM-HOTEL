...
<head>
    ...
    <title>PERCOM-HOTEL|BEDROOM QUALITY LIST</title>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES QUALITES DE CHAMBRES</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Qualite Chambres</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="2">QUALITE CHAMBRES INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>NOM DE LA QUALITE</th>
                                                                    <th>DATE DE CREATION</th>
                                                                    <th>ACTIONS</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach($qualitechambres as $qualitechambre)
                                                                    <tr>
                                                                        <td>{{ $qualitechambre['name']}}</td>
                                                                        <td>{{ $qualitechambre['created_at']}}</td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-primary btn-outline-primary waves-effect md-trigger" data-modal="modal-13" onclick="previsualiser('{{$qualitechambre['id']}}', '{{$qualitechambre['name']}}')"><i class="fa fa-info"></i></button>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom de la qualite</label>
                                                            <input type="text" class="form-control" disabled="disabled"  id="qualite" name="nom_qualite"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                </div>
                                    ...
                                    <form class="ajoutch" onsubmit="return AddQuality()">
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom de la qualite</label>
                                                            <input type="text" class="form-control"   id="nom_qualite" name="nom_qualite"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                    <div class="col-12 col-sm-6">
...
<script>
  ...
  function addingQuality(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-qualite-chambres')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('qualite-chambres')}}";
                }, 1000);
            }
...
<script>
    function previsualiser(id,name)
    {
        ...
        document.getElementById("modal_header").innerHTML='Information sur la qualite <i class="fa fa-hand-o-right"></i> '+name;
        document.getElementById("qualite").value = name;
    }
</script>
<script>
    $(document).ready(function() {
        ...
        $('.newch').on("click", function() {
            $('.ajoutch').show();
            document.getElementById("modal_header2").innerHTML='Ajout d\'une qualite';
        });
