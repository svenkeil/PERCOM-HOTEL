...
<body>
    ...
    <div class="container">
        <div class="brand-section">
            <div class="row">
                <div class="col-6">
                    <h1 class="text-white">HOTEL Y</h1>
                </div>
                <!-- <div class="col-6">
      ...
      <!--  <div class="body-section">
            ...
            <table class="table-bordered">
                ...
                <tbody>
                    <tr>
						...
						<td>{{ $reglement->total_general}} FCFA</td>
						<td>{{ $reglement->remarque}}</td>
                    </tr>
                    <!-- <tr>
        ...
        <div class="body-section">
            <p>&copy; Copyright 2021 - PERFITCOM Sarl rights reserved. 
                <a href="https://www.perfitcom.com/" class="float-right">www.perfitcom.com</a>
            </p>
        </div>      
    </div>      
