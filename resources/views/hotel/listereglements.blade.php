...
<head>
    ...
    <title>PERCOM-HOTEL|PAYMENTS LIST</title>
    ...
    <style type="text/css">
        ...
        .pcoded-main-container {
            background-image: url("{{asset('files/assets/images/comptable.jpg')}}");
            }
      </style>
</head>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Paiements</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="9">PAIEMENTS</th>
                                                                    <th colspan="4">GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>ID</th>
                                                                    <th>NOM DU CLIENT</th>
                                                                    ...
                                                                    <th>REMARQUE</th>
                                                                    <th>MONTANT PERCU</th>
                                                                    <th>ID RECEPTION</th>                                                                    <th>DATE DE CREATION</th>
                                                                    <th>ACTIONS</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach($reglements as $reglement)
                                                                    <tr>
                                                                        ...
                                                                        @if(!is_null($reglement['reception_id']))
                                                                            <td>{{ $valeurclient::find($valeurreception::find($reglement['reception_id'])['client_id'])['name']}}</td>
                                                                        @else
                                                                            <td>{{ $reglement['info_ext']}}</td>
                                                                        @endif
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $reglement['total_restau']}}</td>                                                                                                                             
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $reglement['total_nuitees']}}</td>                                                                                                                             
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $reglement['total_general']}}</td>                                                                                                                             
                                                                        <td>{{ $reglement['remarque']}}</td>                                                                                                                             
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $reglement['prix_rem']}}</td>                                                                                                                             
                                                                        <td>{{ $reglement['reception_id']}}</td>                                                                                                                             
                                                                        <td>{{ $reglement['created_at']}}</td>                                                                
                                                                        <td><a href="" class="btn btn-primary">Previsualiser</a></td>                                                               
                                                                        <td><a href="" class="btn btn-primary">Imprimer</a></td>   
                                                                        <td><a href="{{route('download-pdf', ['id' => $reglement['id']])}}" class="btn btn-primary">Fact. Reception</a></td> 
                                                                       <!-- @if($reglement['total_restau'] != 0)
                                                                            <td><a href="{{route('download-pdf-restau', ['id' => $reglement['id']])}}" class="btn btn-primary">Fact. Restau</a></td>                                                            
                                                                        @else
                                                                            <td></td>
                                                                        @endif -->
                                                                        <td><a href="{{route('download-pdf-restau', ['id' => $reglement['id']])}}" class="btn btn-primary">Fact. Restau</a></td>                                                            
