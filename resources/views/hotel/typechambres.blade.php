...
<head>
    ...
    <title>PERCOM-HOTEL|BEDROOM TYPE LIST</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Type Chambres</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="4">TYPE CHAMBRES INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>NOM DU TYPE</th>
                                                                    <th>NOMBRE DE PERSONNES</th>
                                                                    <th>PERIODE DE VENTE</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($typechambres as $typechambre)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $typechambre['nb_personnes']}}</td>
                                                                        <td>{{ $typechambre['periode_vente']}}</td>
                                                                        <td>{{ $typechambre['created_at']}}</td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-primary btn-outline-primary waves-effect md-trigger" data-modal="modal-13" onclick="previsualiser('{{$typechambre['id']}}', '{{$typechambre['name']}}', '{{$typechambre['nb_personnes']}}', '{{$typechambre['periode_vente']}}')"><i class="fa fa-info"></i></button>
                                        ...
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"   id="type" name="nom_type" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <!-- /.form-group -->
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control"   id="personnes" name="personnes" disabled="disabled"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Periode de vente</label>
                                                            <input type="text" class="form-control"   id="periodevente" name="periode_vente" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Periode de vente</label>
                                                            <select id="periode_vente" name="periode_vente "class="periode_vente form-control">
...
<script>
  ...
  function AddType() {
    ...
    info["periode_vente"] = $(".periode_vente").val();
  ...
  function addingType(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-type-chambres')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('type-chambres')}}";
                }, 1000);
            }
...
<script>
    $(document).ready(function() {
        ...
        $('.newch').on("click", function() {
            $('.ajoutch').show();
            document.getElementById("modal_header2").innerHTML='Ajout d\'un type de chambre';
        });
