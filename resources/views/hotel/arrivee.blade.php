...
<head>
    ...
    <title>PERCOM-HOTEL|ARRIVEE RESERVATION</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Arrivee</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-block">
                                                    <form class="arrivee" onsubmit="return AddArrivee()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Arrivee Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Type de sejour</label>
                                                                                    <select name="type_sejour" class="type_sejour form-control form-control-primary">
                                                                                        <option value="Day Use"> Day Use </option>
                                                                                        <option value="Demi Nuitee"> Demi Nuitee </option>
                                                                                        <option value="Entree en Chambre"> Entree en Chambre </option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
<script>
  ...
  function AddArrivee() {
    ...
    var errors = [];
      ...
      if($(".type_sejour").val() == null) {
        errors.push($(".type_sejour").val());
        } else {
        info["type_sejour"] = $(".type_sejour").val();
        }
  ...
  function addingArrivee(info) {
    $.ajax({
        ...
        url: '{{route('process-arrivee')}}', //process-user-register est  le fichier php excute cote serveur
