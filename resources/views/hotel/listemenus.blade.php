...
<head>
    ...
    <title>PERCOM-HOTEL|MENUS LIST</title>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Menus</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="7">MENU INFORMATION</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($menus as $menu)
                                                                    <tr>
                                                                        <td>{{ $menu['name']}}</td>
                                                                        <td>{{ $menu['code']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $menu['prix']}}</td>
                                                                        <td style="color: #5f4e63;font-weight: bold">{{ $menu['statut']}}</td>
                                                                        <td>{{ $menu['type']}}</td>
                                                                        <td>{{ $menu['date_de_preparation']}}</td>                                                                                                                               
                                                                        <td>{{ $menu['created_at']}}</td>                                                                
                                                                        <td><a href="" class="btn btn-primary">Previsualiser</a></td> 
                                                                        @if($menu['statut'] == 'Disponible')                                                              
                                                                            <td><a href="{{route('menutermine', ['id' => $menu['id']])}}" class="btn btn-primary">Terminer</a></td>                                                               
                                                                        @endif
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                    ...
                                    <form class="ajoutmenu" onsubmit="return AddMenu()">
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="nom_menu" name="nom_menu"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Code</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="code_menu" placeholder="#MOO5" name="code_menu"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Prix</label>
                                                            <input type="number" class="form-control"  font-weight: bolder" id="prix_menu" name="prix_menu"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Type de menu</label>
                                                            <select name="type_menu" class="type_menu form-control form-control-primary">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Date de preparation</label>
                                                            <input type="date" class="form-control"  font-weight: bolder" id="date_preparation" name="date_preparation"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
...
<script>
  ...
  function AddMenu() {
    ...
    var errors = [];
      ...
      if($(".type_menu").val() == null) {
        errors.push($(".type_menu").val());
      } else {
        info["type_menu"] = $(".type_menu").val();
      }
  ...
  function addingMenu(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-menu')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('liste-menus')}}";
                }, 1000);
            }
...
<script>
    $(document).ready(function() {
        ...
        $('.newch').on("click", function() {
            $('.ajoutmenu').show();
            document.getElementById("modal_header2").innerHTML='Ajout d\'un menu';
        });
