...
<head>
    ...
    <title>PERCOM-HOTEL|BEDROOMS OCCUPATIONS</title>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>PLANNING D'OCCUPATION DES CHAMBRES</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Planning D'occupation des chambres</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    ...
                                                                    <th colspan="2">FORMULE DE CHAMBRE</th>
                                                                    ...
                                                                    <tr> 
                                                                        ...
                                                                        <td> {{ $chambre['hs']}}</td>
                                                                            @foreach($receptions as $reception)
                                                                                @if(($reception['statut']== 'En cours' &&  $reception['cloturer']== 'Non') ||($reception['statut']== 'En cours'))
                                                                                    @if($reception['chambre_id']== $chambre['id']) 
                                                                                            <td style="color: #0acd8a;font-weight: bold">{{ $valeurchambres::find($reception['chambre_id'])['statut'] }}</td>
                                                                                            <td>{{ $valeurclients::find($reception['client_id'])['name']}}</td>
                                                                                            <td>{{ $reception['nb_personnes']}}</td>
                                                                                            <td style="color: #5f4e63;font-weight: bold">{{ number_format($valeurchambres::find($reception['chambre_id'])['prix'], 0) }}</td>
                                                                                            <td>{{ $valeurformulechambres::find($valeurchambres::find($reception['chambre_id'])['formule_chambres_id']) ['name'] }}</td>
                                                                                            <td style="color: #dc3545;font-weight: bold">{{ $reception['formule']}}</td>
                                                                                            <td style="color: #dc3545;font-weight: bold">{{ $reception['statut']}}</td>                                                                                   
                                                                                            <td>{{ $reception['date_debut']}}</td>
                                                                                            <td>{{ $reception['date_fin']}}</td>
                                                                                            <td style="color: #5f4e63;font-weight: bold">{{ number_format($reception['prix_total'], 0)}}</td>
                                                                                            <td  style="color: #5f4e63;font-weight: bold"> {{ $reception['rabais']}}</td>
                                                                                            <td>{{ $reception['created_at']}}</td>
                                                                                        <!-- <td><a href="{{route('sortie', ['id' => $reception['id'], 'chid' => $reception['chambre_id']])}}" class="btn btn-primary">Sortie</a></td>-->
                                                                                            <td><a href="{{route('deloger', ['id' => $reception['id']])}}" class="btn btn-primary">Deloger</a></td>
                                                                                            <td><a href="{{route('restaurer', ['id' => $reception['id']])}}" class="btn btn-primary">Restauration</a></td>
                                                                                            @if($reception['formule'] == 'Non')                                                                                                                                     
                                                                                                <td><a href="{{route('formule', ['id' => $reception['id']])}}" class="btn btn-primary">Formule</a></td>                                                                                                                                     
                                                                                            @else
                                                                                                <td></td>
                                                                                            @endif
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  value="{{count($arrivees)}}" font-weight: bolder" id="arrivees" name="arrivees"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{$recouches}}" id="recouches" name="recouches"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{count($chambresoccupees)}}" font-weight: bolder" id="tot_chambres_occupees" name="tot_chambres_occupees"/>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{count($dayuse)}}" font-weight: bolder" id="day_use" name="day_use"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  font-weight: bolder" id="ca_chambre" value="{{$cachambre}}" name="ca_chambre"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  font-weight: bolder" id="ca_day" value="{{$cachambre}}" name="ca_day"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <hr/>
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  font-weight: bolder" id="ca_total" name="ca_total"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  font-weight: bolder" id="hs" value="{{count($hs)}}" name="hs"/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary" disabled="disabled"  value="{{count($deloger)}}" font-weight: bolder" id="delogement" name="delogement"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <hr/>
                                                                <div class="row">
                                                                    <div class="col-12 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-primary"  disabled="disabled" font-weight: bolder" value="{{$taux}}" id="taux" name="taux"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
