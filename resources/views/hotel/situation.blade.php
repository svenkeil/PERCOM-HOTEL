...
<head>
    ...
    <title>PERCOM-HOTEL|GLOBAL SITUATION</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">SITUATION GLOBALE</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <div class="table-responsive dt-responsive">
                                                        <table id="complex-header"
                                                            ...
                                                            <tbody>
                                                                @foreach($clotures as $clotu)
                                                                    <tr>
                                                                        <td>{{ $clotu['date']}}</td>
                                                                        <td>{{ $clotu['heure']}}</td>
                                                                        <td>{{ $clotu['motif']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $clotu['encaissement']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $clotu['decaissement']}}</td>
                                                                        <td>{{ $clotu['created_at']}}</td>
                                                                        <td>
