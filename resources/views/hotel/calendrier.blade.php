...
<head>
    ...
    <title>PERCOM-HOTEL|CALENDAR</title>
    ...
    <!-- Calender css -->
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('files/bower_components/fullcalendar/dist/fullcalendar.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('files/bower_components/fullcalendar/dist/fullcalendar.print.css')}}"
            media='print'>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">CALENDRIER</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-10 col-md-12" style="z-index: 0;">
                                                                    <div id='calendar'></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!--  <div class="card text-center">
                                            <div class="card-block">
                                                <div class="m-t-10">
                                                    ...
                                                    <p class="text-muted m-b-0">Full Calender not supported in this
                                                        device</p>
                                                </div>
                                            </div>
                                        </div> -->
...
<script type="text/javascript" src="{{ URL::asset('files/assets/pages/advance-elements/select2-custom.js')}}"></script>
 ...
 <!-- calender js -->
  <!--classic JS-->
  <script type="text/javascript" src="{{ URL::asset('files/assets/js/classie.js')}}"></script>
 <script type="text/javascript" src="{{ URL::asset('files/bower_components/moment/min/moment.min.js')}}"></script>
    <script type="text/javascript" src="{{ URL::asset('files/bower_components/fullcalendar/dist/fullcalendar.min.js')}}"></script>

    <script type="text/javascript" src="{{ URL::asset('files/assets/pages/full-calender/calendar.js') }}"></script>
