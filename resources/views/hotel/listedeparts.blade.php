...
<head>
    ...
    <title>PERCOM-HOTEL|DEPARTURES LIST</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">LISTE DEPARTS</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                            ...
                                                            <tbody>
                                                                @foreach($departs as $dep)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $dep['heure_depart']}}</td>
                                                                        <td>{{ $valeurclient::find($valeurreception::find($dep['reception_id'])['client_id'])['name']}}</td>
                                                                        <td>{{ $dep['depart_tardif']}}</td>
                                                                        <td>{{ $dep['montant_additionnel']}}</td>
                                                                        <td>{{ $dep['remarque']}}</td>
                                                                        <td>{{ $dep['reception_id']}}</td>
                                                                        <td>{{ $valeurhotel::find($dep['hotel_id'])['name'] }}</td>
