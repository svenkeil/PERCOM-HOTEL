...
<head>
    ...
    <title>PERCOM-HOTEL|BEDROOM FORMULA LIST</title>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES FORMULES DE CHAMBRE</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Formules Chambres</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="2">FORMULES CHAMBRES INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr> <!--MANY YO MANY AVEC HOTEL -->
                                                            ...
                                                            <tbody>
                                                                @foreach($formulechambres as $formulechambre)
                                                                    <tr>
                                                                        <td>{{ $formulechambre['name']}}</td>
                                                                        <td>{{ $formulechambre['created_at']}}</td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-primary btn-outline-primary waves-effect md-trigger" data-modal="modal-13"  onclick="previsualiser('{{$formulechambre['id']}}', '{{$formulechambre['name']}}')"><i class="fa fa-info"></i></button>
                                    ...
                                    <!-- Formulaire previsualisation formule chambre -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"   id="formule" name="nom_formule" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                    ...
                                    <!-- Formulaire ajout formule chambre -->
                                    <form class="ajoutch" onsubmit="return AddFormule()">
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom de la formule</label>
                                                            <input type="text" class="form-control"   id="nom_formule" name="nom_formule"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
...
<script>
  ...
  function addingFormule(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-formule-chambres')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('formule-chambres')}}";
                }, 1000);
            }
...
<script>
    function previsualiser(id,name)
    {
        ...
        document.getElementById("modal_header").innerHTML='Information sur la formule <i class="fa fa-hand-o-right"></i> '+name;
        document.getElementById("formule").value = name;
    }
</script>
<script>
    $(document).ready(function() {
        ...
        $('.newch').on("click", function() {
            $('.ajoutch').show();
            document.getElementById("modal_header2").innerHTML='Ajout d\'une formule de chambre';
        });
