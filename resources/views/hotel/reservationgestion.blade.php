...
<head>
    ...
    <title>PERCOM-HOTEL|BOOKINGS GESTION</title>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>GESTION DES RESERVATIONS</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Gestion Reservations</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="11">RESERVATIONS INFORMATION</th>
                                                                    <th colspan="4">DETAILS INFORMATION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>STATUT</th>
                                                                    <th>NOM COMPLET</th>
                                                                    <th>ARRIVEE EFFECTUEE</th>
                                                                    <th>CANAL</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($reservations as $reserv)
                                                                    @if(($reserv['statut']== 'Reserve' &&  $reserv['cloturer']== 'Non') ||($reserv['statut']== 'Reserve'))
                                                                        <tr> 
                                                                            <td style="color: #0acd8a;font-weight: bold">{{ $reserv['statut'] }}</td>
                                                                            <td>{{ $valeurclient::find($reserv['client_id'])['name']}}</td>
                                                                            <td>{{ $reserv['arrivee_effectuee']}}</td>
                                                                            <td>{{ $valeurtype::find($reserv['type_reservation_id'])['name']}}</td>
                                                                            <td>{{ $reserv['nb_nuits']}}</td>
                                                                            <td>{{ $reserv['nb_chambres']}}</td>
                                                                            <td>{{ $reserv['nb_adultes'] + $reserv['nb_enfants']}}</td>
                                                                            <td>{{ $reserv['date_debut']}}</td>
                                                                            <td>{{ $reserv['date_fin']}}</td>
                                                                            <td style="color: #5f4e63;font-weight: bold">{{ number_format($reserv['prix_total'], 0) }}</td>  
                                                                            <td>{{ $valeuruser::find($reserv['created_by'])['name']}}</td>                                                                                       
                                                                            <td>{{ $reserv['created_at']}}</td>
                                                                            <td><a href="{{route('voir', ['id' => $reserv['id']])}}" class="btn btn-primary">Voir</a></td>
                                                                            <td><a href="{{route('arrivee', ['id' => $reserv['id']])}}" class="btn btn-primary">Arrivee</a></td>
                                                                            <td><a href="{{route('regler-reserv', ['id' => $reserv['id']])}}" class="btn btn-primary">Regler</a></td>
                                                                            <td><a href="{{route('download-pdf-reserv', ['id' => $reserv['id']])}}" class="btn btn-primary">Facture - Reservation</a></td>                                                            
                                                                        <tr/>
                                                                    @endif
