...
<head>
    ...
    <title>PERCOM-HOTEL|CUSTOMER DEPART</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Depart CLIENT</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="restauration" onsubmit="return AddDepart()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Depart Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                        <div class="row">
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Date d'arrivee</label>
                                                                                    <input type="date" class="form-control form-control-primary" disabled="disabled" value="{{ $id->date_debut }}" id="arrivee_recep" name="arrivee_recep"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <label>Date de depart</label>
                                                                                    <input type="date" class="form-control form-control-primary" disabled="disabled" value="{{ $id->date_fin }}"  id="depart_recep" name="depart_recp"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <hr/>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" value="0" id="montant_additionnel" name="montant_additionnel"/>
                                                                                </div>
                                                                        <!-- /.form-group -->
                                                                            </div>
                                                                        </div>
...
<script>
  ...
  function AddDepart() {
    ...
    var errors = [];
      ...
      info["remarque"] = $('#remarque').val(); 
        ...
        if($(".depart_tardif").val() == null) {
            errors.push($(".depart_tardif").val());
        } else {
        info["depart_tardif"] = $(".depart_tardif").val();
        }
      // console.log(info);
      console.log(errors);
    if (errors.length > 0) {
  ...
  function addingDepart(info) {
    $.ajax({
        ...
        url: '{{route('process-depart')}}', //process-user-register est  le fichier php excute cote serveur
