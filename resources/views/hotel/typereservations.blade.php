...
<head>
    ...
    <title>PERCOM-HOTEL|RESERVATIONS TYPE LIST</title>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES TYPES DE RESERVATIONS</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Type Reservations</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="2">TYPE RESERVATION INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    <th>NOM DU TYPE</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($typereservations as $type)
                                                                    <tr>
                                                                        <td>{{ $type['name']}}</td>
                                                                        <td>{{ $type['created_at']}}</td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-primary btn-outline-primary waves-effect md-trigger" data-modal="modal-13" onclick="previsualiser('{{$type['id']}}', '{{$type['name']}}')"><i class="fa fa-info"></i></button>
...
<script>
  ...
  function addingType(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-type-reservation')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('type-reservation')}}";
                }, 1000);
            }
...
<script>
    $(document).ready(function() {
        ...
        $('.newch').on("click", function() {
            $('.ajoutch').show();
            document.getElementById("modal_header2").innerHTML='Ajout d\'un type de reservation';
        });
