...
<head>
    ...
    <title>PERCOM-HOTEL|OCCUPATIONS HISTORY</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Historique de reception </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                            ...
                                                            <tbody>
                                                                @foreach($receptions as $reception)
                                                                    @if($reception['statut'] == 'Terminee')
                                                                        <tr>
                                                                            <td>{{ $valeurchambres::find($reception['chambre_id'])['name'] }}</td>
                                                                            <td>{{ $valeurclients::find($reception['client_id'])['name']}}</td>
                                                                            <td>{{ $reception['nb_personnes']}}</td>
                                                                            <td>{{ number_format($reception['prix_total'], 0)}}</td>
                                                                            ...
                                                                            <td><a href="{{route('download-pdf', ['id' => $reception['id']])}}" class="btn btn-primary">PDF</a></td>
