...
<head>
    ...
    <title>PERCOM-HOTEL|CUSTOMER DISLODGE</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">DELOGER CLIENT</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="card-block">
                                                    <form class="delogement" onsubmit="return AddDelogement()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Delogement Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-6">
                                                                            <div class="form-group">
                                                                                <label>Nouvelle Chambre</label>
                                                                                    <select name="nv_chambre" class="nv_chambre form-control form-control-primary">
                                                                        ...
                                                                        <div class="col-12 col-sm-6">
                                                                            <div class="form-group">
                                                                                <label> Id du delogement</label>
                                                                                <input type="text" class="form-control form-control-primary" font-weight: bolder" id="id_delogement" placeholder="#POO1D" name="id_delogement"/>
                                                                            </div>
                                                                        </div>
                                                                        </div>
                                                                        <hr/>
                                                                        ...
                                                                        <!-- /.form-group -->
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-primary" disabled="disabled" value="{{ $id->id }}" font-weight: bolder" id="id_reception" name="id_reception"/>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12 col-sm-12">
                                                                            <textarea class="form-control form-control-primary" id="raison_delog" name="remarque" rows="3" placeholder="Raison"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <hr/>
                                                                    <div class="row">
...
<script>
  ...
  function AddDelogement() {
    ...
    var errors = [];
      ...
      info["raison"] = $('#raison_delog').val(); 

        if($(".nv_chambre").val() == null) {
        errors.push($(".nv_chambre").val());
        } else {
        info["nv_chambre"] = $(".nv_chambre").val();
        }
      // console.log(info);
      console.log(errors);
    if (errors.length > 0) {
   ...
   addingDelogement(info);     
  }

  // login pour la connexion
  function addingDelogement(info) {
    $.ajax({
        ...
        url: '{{route('process-delogement')}}', //process-user-register est  le fichier php excute cote serveur
