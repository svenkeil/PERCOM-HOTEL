...
<head>
    ...
    <title>PERCOM-HOTEL|RESTAURATEURS LIST</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Retaurateurs</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <div class="table-responsive dt-responsive">
                                                        <table id="complex-header"
                                                            ...
                                                            <tbody>
                                                                @foreach($restaurateurs as $restau)
                                                                    <tr>
                                                                        <td>{{$valeuruser::find($restau['user_id'])['pseudo']}}</td>
                                                                        <td>{{$valeuruser::find($restau['user_id'])['email']}}</td>
                                                                        <td>{{ $restau['matricule']}}</td>
                                                                        <td>{{ $restau['start_date']}}</td>
                                                                        <td>{{ $restau['end_date']}}</td>
                                                                        <td>{{ $restau['no_compte']}}</td>
                                                                        <td style="color: #dc3545;font-weight: bold">{{ $restau['revenu']}}</td>
                                                                        <td>{{ $restau['created_at']}}</td>
                                                                        <td>
