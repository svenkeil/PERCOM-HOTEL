...
<head>
    ...
    <title>PERCOM-HOTEL|FORMULES LIST</title>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>LISTE DES FORMULES AUX CLIENTS</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Formules Clients</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="7">FORMULES INFOMATIONS</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($formule as $form)
                                                                    @if($form['cloturer'] == 'Non')
                                                                        <tr>
                                                                            <td>{{ $form['date']}}</td>
                                                                            <td>{{ $form['heure']}}</td>
                                                                            <td>{{ $form['menus']}}</td>
                                                                            <td>{{ $valeurclient::find($valeurreception::find($form['reception_id'])['client_id'])['name']}}</td>
                                                                            <td>{{ $form['remarque']}}</td>
                                                                            <td>{{ $form['reception_id']}}</td>
