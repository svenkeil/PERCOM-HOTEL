...
<head>
    ...
    <title>PERCOM-HOTEL|HS HISTORY</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste des hs </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="4">HS INFORMATION</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($hs as $hors)
                                                                    @if($hors['cloturer'] == 'Non')
                                                                        <tr>
                                                                            <td>{{ $valeurchambre::find($hors['chambre_id'])['name'] }}</td>
                                                                            <td>{{ $hors['raison']}}</td>
                                                                            <td>{{ $valeurhotel::find($hors['hotel_id'])['name'] }}</td>
                                                                            <td>{{ $hors['created_at']}}</td>
