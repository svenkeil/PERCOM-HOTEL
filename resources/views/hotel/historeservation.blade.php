...
<head>
    ...
    <title>PERCOM-HOTEL|BOOKINGS LIST</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Historique Reservations</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="8">RESERVATIONS INFORMATION</th>
                                                                    <th colspan="1">DETAILS INFORMATION</th>
                                                                </tr>
                                                                    <th>STATUT</th>
                                                                    <th>NOM COMPLET</th>
                                                            ...
                                                            @foreach($reservations as $reserv)
                                                                    @if(($reserv['statut']== 'Termine' &&  $reserv['cloturer']== 'Non') ||($reserv['statut']== 'Termine'))
                                                                        <tr> 
