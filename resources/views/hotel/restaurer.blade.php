...
<head>
    ...
    <title>PERCOM-HOTEL|CUSTOMER RESTAURATION</title>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Restauration CLIENT</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-block">
                                                    <form class="restauration" onsubmit="return AddRestauration()">
                                                            <div class="md-content">
                                                                <h3 style="background-color: #a99166" align="center">Restauration Client: <strong style="color:#5e281c">{{$valeurclient::find($id->client_id)->name}}</strong></h3>
                                                                <div>
                                                                    <div class="row">
...
<script>
  ...
  function addingRestauration(info) {
    $.ajax({
        ...
        url: '{{route('process-restauration')}}', //process-user-register est  le fichier php excute cote serveur
