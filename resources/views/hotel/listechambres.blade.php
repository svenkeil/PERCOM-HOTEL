...
<head>
    ...
    <title>PERCOM-HOTEL|BEDROOM LIST</title>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"  style="float: left;"><a href="#!">Liste Chambres</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <table id="complex-header"
                                                            ...
                                                            <thead>
                                                                <tr style="background-color: #b82710; text-align: center">
                                                                    <th colspan="14">CHAMBRES INFORMATION</th>
                                                                    <th>GESTION</th>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <th>QUALITE DE CHAMBRE</th>
                                                                    <th>FORMULE DE CHAMBRE</th>
                                                                    <th>HOTEL</th>
                                                            ...
                                                            <tbody>
                                                                @foreach($listechambres as $chambre)
                                                                    <tr>
                                                                        <td>{{ $chambre['name'] }}</td>  
                                                                        <td>{{ $chambre['code'] }}</td> 
                                                                        <td style="color: #dc3545;font-weight: bold">{{ number_format($chambre['prix'], 0) }}</td>
                                                                        <td>{{ $chambre['statut'] }}</td> 
                                                                        <td>{{ $chambre['reserver'] }}</td> 
                                                                        <td>{{ $chambre['deb_reserv'] }}</td> 
                                                                        <td>{{ $chambre['fin_reserv'] }}</td> 
                                                                        <td>{{ $valeurtype::find($chambre['type_chambres_id'])['name'] }}</td>
                                                                        <td>{{ $valeurqual::find($chambre['qualite_chambres_id'])['name'] }}</td>
                                                                        <td>{{ $valeurform::find($chambre['formule_chambres_id'])['name'] }}</td>
                                                                        <td>{{ $valeurhot::find($chambre['hotel_id'])['name'] }}</td>
                                                                        <td>{{ $chambre['created_at'] }}</td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-primary btn-outline-primary waves-effect md-trigger" data-modal="modal-13" onclick="previsualiser('{{$chambre['id']}}','{{$chambre['name']}}','{{$chambre['code']}}','{{$chambre['prix']}}', '{{ $chambre['statut'] }}', '{{$chambre['description']}}', '{{ $valeurtype::find($chambre['type_chambres_id'])['name'] }}', '{{ $valeurqual::find($chambre['qualite_chambres_id'])['name'] }}', '{{ $valeurform::find($chambre['formule_chambres_id'])['name'] }}', '{{ $valeurhot::find($chambre['hotel_id'])['name'] }}')"><i class="fa fa-info"></i></button>
                                                                            ...
                                                                            <td><a href="{{route('hs', ['id' => $chambre['id']])}}" class="btn btn-primary">HS</a></td>                                                                                                                                                                                                                                                                          
                                                                            <td><a href="{{route('end-hs', ['id' => $chambre['id']])}}" class="btn btn-primary">End HS</a></td>                                                                                                                                                                                                                                                                          
                                    ...
                                    <!-- Formulaire previsualisation chambre -->
                                        ...
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="nomchambre" name="nom_chambre"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Prix</label>
                                                            <input type="number" class="form-control" disabled="disabled" font-weight: bolder" id="prix" placeholder="0.00" name="prix"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Code de la chambre</label>
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="codechambre" name="code_chambre"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="description" name="description"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="typechambre" name="type_chambre"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Qualite de chambre</label>
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="qualitechambre"  name="qualite_chambre"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Formule de chambre</label>
                                                            <input type="text" class="form-control" disabled="disabled" font-weight: bolder" id="formulechambre" name="formule_chambre"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                    ...
                                    <form class="ajoutch" onsubmit="return AddBedRoom()">
                                        <div class="md-content">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Nom de la chambre</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="nom_chambre" name="nom_chambre"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                        <!-- /.col -->
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Prix</label>
                                                            <input type="number" class="form-control"  font-weight: bolder" id="prix" placeholder="0.00" name="prix"/>
                                                        </div>
                                                    <!-- /.form-group -->
                                                    </div>
                                                    <!-- /.col -->
                                                ...
                                                <div class="row">
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                <label>Type de chambre</label>
                                                                <select name="select" class="type_chambre form-control form-control-primary"> 
                                                                @foreach($typechambres as $typech)
                                                                    <option value="{{ $typech['id'] }}">{{ $typech['name'] }}</option>
                                                                @endforeach
                                                                </select>
                                                            </div>
                                                        <!-- /.form-group -->
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                <label>Qualite de chambre</label>
                                                                <select name="select" class="qualite_chambre form-control form-control-primary"> 
                                                                @foreach($qualitechambres as $qualitech)
                                                                    <option value="{{ $qualitech['id'] }}">{{ $qualitech['name'] }}</option>
                                                                @endforeach
                                                                </select>
                                                            </div>
                                                    <!-- /.form-group -->
                                                ...
                                                <div class="row">
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                <label>Formule de chambre</label>
                                                                <select name="select" class="formule_chambre form-control form-control-primary"> 
                                                                @foreach($formulechambres as $formulech)
                                                                    <option value="{{ $formulech['id'] }}">{{ $formulech['name'] }}</option>
                                                                @endforeach
                                                                </select>
                                                            </div>
                                                        <!-- /.form-group -->
                                                        ...
                                                        <div class="col-12 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="select" class="hotel form-control form-control-primary"> 
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label>Code de la chambre</label>
                                                            <input type="text" class="form-control"  font-weight: bolder" id="code_chambre" name="code"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control"  font-weight: bolder" id="photo_chambre" name="photo"/>
                                                        </div>
                                                        <!-- /.form-group -->
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-sm-12">
                                                        <textarea class="form-control" id="description_aj" name="description" rows="3" placeholder="Description"></textarea>
                                                    </div>
                                                </div>
                                                <hr/>
                                                <div class="row">
...
<script>
  ...
  function AddBedRoom() {
    ...
    var errors = [];
      ...
      info["description"] = $("#description_aj").val();

      if($(".type_chambre").val() == null) {
        errors.push($(".type_chambre").val());
      } else {
        info["type_chambre"] = $(".type_chambre").val();
      }

      if($(".qualite_chambre").val() == null) {
        errors.push($(".qualite_chambre").val());
      } else {
        info["qualite_chambre"] = $(".qualite_chambre").val();
      }

      if($(".formule_chambre").val() == null) {
        errors.push($(".formule_chambre").val());
      } else {
        info["formule_chambre"] = $(".formule_chambre").val();
      }
  ...
  function addingBedroom(info) {
    $.ajax({
        ...
        url: '{{route('process-ajout-chambres')}}', //process-user-register est  le fichier php excute cote serveur
        ...
        success:function(response){
            ...
            if(response.status=='success'){
                ...
                setTimeout(()=>{
                    window.location.href="{{route('liste-chambres')}}";
                }, 1000);
            }
